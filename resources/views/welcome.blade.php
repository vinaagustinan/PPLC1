        ...
        <ul>
            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                ...
                <div class="slider_text_box">
                    ...
                    data-textAlign="['left','left','left','left','left','center']">
                        <img src="sierra/img/home-slider/slider-m-1.png" alt="">
                    </div>
                </div>
            </li>
            ...
            <!-- LAYERS -->
                ...
                <div class="slider_text_box">
                    ...
                    data-responsive_offset="on" 
                    data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:0px;s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                    data-textAlign="['left','left','left','left','left','center']">Mempermudah Segalanya <br />design for your Start-up</div>
...
<section class="feature_area">
    <div class="container">
        <div class="c_title">
            <img src="sierra/img/icon/title-icon.png" alt="">
            <h6>Let's Easy</h6>
            <h2>Rendemen-Cane are Solution</h2>
        </div>
        <div class="row feature_inner">
            <div class="col-lg-4 col-sm-6">
                <div class="feature_item">
                    <div class="f_icon">
                        <img src="sierra/img/icon/f-icon-1.png" alt="">
                    </div>
                    <h4>Transparansi</h4>
                    <p>Petani bisa melihat rata-rata rendemen pada pabrik tebu</p>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="feature_item">
                    <div class="f_icon">
                        <img src="sierra/img/icon/f-icon-2.png" alt="">
                    </div>
                    <h4>Sistem Antrian</h4>
                    <p>Petani tidak perlu menunggu lama lagi di depan pabrik untuk melakukan perhitungan rendemen</p>
                    <!-- <a class="more_btn" href="#">Read More</a> -->
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="feature_item">
                    <div class="f_icon">
                        <img src="sierra/img/icon/f-icon-3.png" alt="">
                    </div>
                    <h4>Online</h4>
                    <p>Pendaftaran dan pendataan dilakukan secara online</p>
                    <!-- <a class="more_btn" href="#">Read More</a> -->
                </div>
            </div>
        </div>
...
<section class="best_3d_area">
    <div class="left_3d">
        <div class="shap_slider_inner owl-carousel">
            <div class="item">
                <h4>“Great Team”</h4>
                <p>Great Application develop from Great People</p>
                <div class="media">
                    <!-- <img src="sierra/img/team/people/people-5.jpg" alt=""> -->
        ...
        <div class="right_text_inner">
            <div class="text_3d">
                <div class="l_title">
                    ...
                    <h2>It's make all simple</h2>
                </div>
                <p>Sistem pendaftaran dan antrian dilakukan secara online membuat semuanya terasa lebih mudah</p>
            </div>
            <div class="shap_mobile">
                <img src="sierra/img/iphone4.png" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="team_people_text">
                    ...
                    <p>Kelompok 1 PPL C :</p>
                    <ul>
                        <li><a href="#">Siti Nurdiana 18-1028</a></li>
                        <li><a href="#">Nadia Cahya Rani 18-1031</a></li>
                        <li><a href="#">Neta Hardy Astuty 18-1050</a></li>
                        <li><a href="#">Nisvi Maulidyah 18-1102</a></li>
                        <li><a href="#">Vina Agustina Nawawi 18-1116</a></li>
                        <li><a href="#">M. Fawwaz Ikbar R. 18-1143 </a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="sierra/img/team/people/people-1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="sierra/img/team/people/people-2.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="sierra/img/team/people/people-3.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="sierra/img/team/people/people-4.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row get_touch_inner">
            ...
            <div class="col-lg-6">
                <div class="touch_details">
                    ...
                    <p>Let's develop other great application with us</p>
                    <a href="#"><h5>Call us now</h5></a>
                    <a href="#"><h4>+62 18 2410 1011</h4></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="world_map_area p_100">
    <div class="container">
        <div class="world_map_inner">
            <img class="img-fluid" src="sierra/img/world-map.png" alt="">
            <div class="bd-callout">
                <h3>PPLC1 Office</h3>
                <p>Sistem Informasi, Fakultas Ilmu Komputer <br /> Universitas Jember</p>
                <h4><a href="#">+62 18 2410 1011</a> <a href="#">contact@rendemen-cane.com</a></h4>
            </div>
        </div>
    </div>
</section>
